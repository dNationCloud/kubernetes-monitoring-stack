...
sed -i 's@static/img/grafana_icon\.[a-f0-9]*\.svg@../img/dnation_logo.svg@g' /usr/share/grafana/public/build/*.js
#Modify app title
...
sed -i 's/AppTitle="Grafana"/AppTitle="dNation"/g' /usr/share/grafana/public/build/*.js
